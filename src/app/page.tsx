...
const DEMO_IMAGE_POSTS: Post[] = [
  {
    id: 'demo-1', created_at: new Date().toISOString(), author_name: 'Anonymous',
  ...
  {
    id: 'demo-2', created_at: new Date().toISOString(), author_name: 'Anonymous',
    title: 'The Eye', content: null,
    image_url: '/gallery/IMG_5615.png',
    post_type: 'image', category: 'art', status: 'approved', moderator_notes: null,
  },
  {
    id: 'demo-3', created_at: new Date().toISOString(), author_name: 'Anonymous',
